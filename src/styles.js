const styles = {
    ...
    heroHeadText:
      'font-black text-taupe text-eerieBlack lg:text-[40px] sm:text-[30px] xs:text-[24px] text-[32px] lg:leading-[80px] mt-2',
    heroSubText:
    ...
    sectionSubText:
      'sm:text-[18px] font-black  text-eerieBlack text-[16px] text-taupe uppercase tracking-wider',
    sectionSubTextLight:
